/*
Kubernetes dashboard deplopyment
*/
...
resource "kubernetes_manifest" "serviceaccount_kubernetes_dashboard_kubernetes_dashboard" {
  ...
  depends_on = [kubernetes_manifest.namespace_kubernetes_dashboard]
...
//To be reviewed for security, to simplify we will set up the default one for now
