...
resource "kubernetes_manifest" "ingress_argocd_argocd_server_http_ingress" {
  manifest = {
    "apiVersion" = "networking.k8s.io/v1"
    "kind" = "Ingress"
    "metadata" = {
  ...
  depends_on = [
    kubernetes_manifest.service_argocd_server
  ]
}

resource "kubernetes_manifest" "ingress_argocd_argocd_server_grpc_ingress" {
  manifest = {
    "apiVersion" = "networking.k8s.io/v1"
    "kind" = "Ingress"
    "metadata" = {
